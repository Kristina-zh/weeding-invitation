...
export const weddingTranslations = {
  English: [
    ...
    },
    {
      ...
      content: [
        'On the day of the wedding, return transport to the Hacienda will be provided for guests that require it. Pick up and returns will be at the Radisson, Fiesta Inn and One hotels only.',
    ...
    },
    {
      ...
      content: [
        'Formal attire.',
        'You can find our colour guidelines and some inspiration here:',
      ],
  ...
  Ukrainian: [
    ...
    },
    {
      title: 'Як дістатися',
      content: [
        'У день весілля буде організовано транспорт до маєтку для гостей, які цього потребують. Транспорт курсуватиме лише між готелями Radisson, Fiesta Inn і One.',
    ...
    },
    {
      title: 'Лише дорослі',
      content: [
        'Ми любимо дітей, але під час цієї особливої події хочемо, щоб ви мали змогу відпочити, розслабитися та повністю насолодитися святкуванням без будь-яких турбот.',
      ],
    },
  ],
};
...
export const accomodationTranslations = {
  ...
  Spanish: {
    description1:
      'Morelos es uno de los destinos de bodas más populares de México. Por lo tanto, los hoteles se saturan rápidamente.',
    description2:
...
export const rsvpTranslations = {
  English: {
    ...
    question3: 'Do you have any allergies?',
    ...
    isJoiningIsRequired: 'Please confirm your attendance.',
    allergiesIsRequired: 'Please confirm if you have any allrgies.',
  },
  Spanish: {
    ...
    phoneIsRequired: 'Se requiere el número de teléfono.',
    isJoiningIsRequired: 'Por favor, confirma tu asistencia.',
    allergiesIsRequired: 'Por favor, confirma si tienes alguna alergia.',
  },
  Russian: {
    ...
    phoneIsRequired: 'Необходим номер телефона.',
    isJoiningIsRequired: 'Пожалуйста, подтвердите свое участие.',
    allergiesIsRequired: 'Пожалуйста, подтвердите, есть ли у вас аллергия.',
  },
  Ukrainian: {
    ...
    phoneIsRequired: 'Необхідний номер телефону.',
    isJoiningIsRequired: 'Будь ласка, підтвердьте свою присутність.',
    allergiesIsRequired: 'Будь ласка, підтвердьте, чи маєте ви алергію.',
  },
};
